var PowerCards = PowerCards || (function() {
	...
	// INLINE ROLL COLORS
	var INLINE_ROLL_DEFAULT = " background-color: #ffe290; border-color: #87850A; color: #000000;"; // !!! default " background-color: #FFFEA2; border-color: #87850A; color: #000000;"; 
	...
	var INLINE_ROLL_STYLE = "text-align: center; font-size: 100%; display: inline-block; font-weight: bold; height: 1.15em; min-width: 1.75em; margin-top: -1px; margin-bottom: 1px; padding: 0px 2px; border: 1px solid; border-radius: 3px;";
	...
	PowerCard.Process = function(msg, player_obj) {
		...
		//var PlayerTXShadow = (getBrightness(PlayerBGColor) < (255 / 2)) ? "#000000" : "#FFFFFF";
    		...
    		PowerCard.titlebackground = "linear-gradient(rgba(255, 255, 255, .2), rgba(255, 255, 255, 0));"; // !!! changed rgba(255, 255, 255, .3) to rgba(255, 255, 255, .1)
    		PowerCard.subtitlefont = "Helvetica";
    		PowerCard.subtitlefontvariant = "small-caps"; // !!! default "normal"
    		PowerCard.bodyfont = "Helvetica";
   		PowerCard.titlefontsize = "1.4em; line-height: 1.2em"; // !!! default "1.2em; line-height: 1.2em"
    		PowerCard.subtitlefontsize = "12px"; // !!! default 11px
    		PowerCard.bodyfontsize = "14px"; //  default 14px
    		PowerCard.txcolor = PlayerTXColor;
    		PowerCard.bgcolor = PlayerBGColor;
    		PowerCard.erowtx = "#000000";
    		PowerCard.erowbg = "#cfbbae"; // #B6AB91 - Default darker brown !!!
    		PowerCard.orowtx = "#000000";
    		PowerCard.orowbg = "#e5d5ca"; // #CEC7B6 - Default light brown !!!
    		PowerCard.corners = 2; // Set to 0 to remove rounded corners from PowerCards !!! default ~5
		...
		safeSendChat("", JSON.stringify(PowerCard), function(x) {
			...
			// ADD SUBTITLES...  !!! This is the part that I edited to get rid of the little Diamond the power card has by default.
        		var Diamond = " &" + "#x20; ";
